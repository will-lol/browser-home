...
export default function Home(props: PageProps) {
  const startFromParam: string | number | null = props.url.searchParams.get("start");
  const endFromParam: string | number | null = props.url.searchParams.get("end");
  ...
  return (
    <main class="h-screen flex flex-col items-center justify-center">
      <div class="w-96 p-1 h-8 relative shadow border border-gray-300 dark:border-[#505057] border-solid rounded-full bg-gray-200 dark:bg-[#44434d]">
        <div class="flex items-start h-full overflow-hidden rounded-full w-full">
          <div
        ...
        <div
          class={`ml-[-1%] shadow absolute bg-blue-500 rounded-full bottom-[170%] mt-3 w-fit translate-x-[-50%] z-0 left-[${yearProgressPercentage}%]`}
        >
